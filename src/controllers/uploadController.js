...
const uploadVideo = async (req, res) => {
    try {
        ...
        const { token, code_id, template, text } = value;
        ...
        const backgroundPath = path.join(projectRoot, `public/templates/${template}/BACKGROUND.mp4`);
        const iconPath = path.join(projectRoot, `public/templates/${template}/ICON.mov`);
