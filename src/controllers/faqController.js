...
const getFaqList = async (req, res) => {
  try {
    ...
    const faqData = await faqService.getAllFaqs({
      search,
      currentPage,
      itemsPerPage,
    });
    return response.success(res, faqData, ERROR_MESSAGES.FAQ_FETCH_SUCCESS);
  } catch (error) {
...
const updateFaq = async (req, res) => {
  try {
    ...
    return response.success(
      res,
      { id: updatedFaqId, faq_question, faq_answer },
      ERROR_MESSAGES.FAQ_UPDATE_SUCCESS
    );
  } catch (error) {
...
const deleteFaq = async (req, res) => {
  try {
    ...
    return response.success(
      res,
      { id: deletedFaqId },
      ERROR_MESSAGES.FAQ_DELETE_SUCCESS
    );
  } catch (error) {
